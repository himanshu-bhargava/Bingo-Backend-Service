...
public class GamePlayService {
	...
	public Map<String, Object> poll(Long roomId, Long myId) {
		...
		if (null != myId) {
			EmojiEntity emoji = emojiRepository.getUnsentEmoji(myId, roomId);
			if (emoji != null) {
				emoji.setAlreadySent(true);
				emojiRepository.save(emoji);
				response.put(EMOJI,
						new EmojiRequestResponse(emoji.getSender(), emoji.getReceiver(), emoji.getSticker()));
			}
